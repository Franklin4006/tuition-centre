...
@section('content')
                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <button class="btn btn-primary add-btn" data-toggle="modal" data-target="#standards-modal">
    ...
    <div class="modal fade" id="standards-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
...
@section('addscript')
    <script type="text/javascript">
        ...
        $(document).on("click", ".edit-btn", function() {
            ...
            $("#edit_id").val(edit_id);
            $.ajax({
                url: "{{ route('standards.index') }}/" + edit_id,
                dataType: "json",
                success: function(response) {
        ...
        $(document).on("click", "#status-confirm-btn", function() {
            ...
            $.ajax({
                url: "{{ route('standards.chage_status') }}",
                data: {
                    edit_id: edit_id,
                    status: status
                },
